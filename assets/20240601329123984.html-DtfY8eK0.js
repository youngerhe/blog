import{_ as s}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as n,o as a,b as e}from"./app-CtbYvwav.js";const i={},l=e(`<h1 id="《mbit》grpc-gateway-的使用" tabindex="-1"><a class="header-anchor" href="#《mbit》grpc-gateway-的使用"><span>《Mbit》grpc-gateway 的使用</span></a></h1><h2 id="一、安装" tabindex="-1"><a class="header-anchor" href="#一、安装"><span>一、安装</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>$ go get github.com/grpc-ecosystem/grpc-gateway/v2/protoc-gen-grpc-gateway</span></span>
