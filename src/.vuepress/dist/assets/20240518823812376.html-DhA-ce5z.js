import{_ as n}from"./plugin-vue_export-helper-DlAUqK2U.js";import{c as s,o as a,b as i}from"./app-CtbYvwav.js";const e={},l=i(`<h1 id="《mbit》gin-gorm-搭建项目" tabindex="-1"><a class="header-anchor" href="#《mbit》gin-gorm-搭建项目"><span>《Mbit》gin+gorm 搭建项目</span></a></h1><ul><li><strong>基础架构搭建，后续服务会以此为标准</strong></li></ul><h2 id="一、目录结构" tabindex="-1"><a class="header-anchor" href="#一、目录结构"><span>一、目录结构</span></a></h2><div class="language- line-numbers-mode" data-highlighter="shiki" data-ext="" data-title="" style="--shiki-light:#383A42;--shiki-dark:#abb2bf;--shiki-light-bg:#FAFAFA;--shiki-dark-bg:#282c34;"><pre class="shiki shiki-themes one-light one-dark-pro vp-code"><code><span class="line"><span>├── api             // 业务接口</span></span>
